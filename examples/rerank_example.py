...
from utils.api_keys import *  # Import your API keys from a secure location
...
async def test_rerank_with_different_settings():
    ...
    print(f"   Preview: {result_with_rerank[:1000]}...")
    ...
    print(f"   Preview: {result_without_rerank[:1000]}...")
